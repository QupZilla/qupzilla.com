	...
	<div id="logbase">
      ...
      <nav>
        <ul>
          ...
          <li><a href="contribute" class="current" >Contribute</a></li>
        </ul>
      </nav>
    </div>
  </header>
 <section id="content">
     ...
     <div class="row-1 row">
      	<div class="wrapper">
          	...
          	<h2>Contribute to QupZilla</h2>
            <img id="map_contribute" src="images/map.gif" alt="">
              <p>QupZilla is an open source project, so your help is very welcome! I will be very happy to include patches you send me. But hacking into code is not the only one way to help: You can translate QupZilla to your language or just share it with your friends. Remember, every (even small) help is highly appreciated!            </p>
            <h4>Getting Source</h4>
            <p>The easiest way you can get QupZilla source is to clone it from github repository. You can do it by running this command            <pre>$ git clone git://github.com/QupZilla/qupzilla.git</pre>
            <br/>and then you can start hacking. You can send me your patches by e-mail or at github.            </p>
            <h4>Translating into other languages</h4>
            <p>Another way how to contribute is to add or improve current translations. If you want add new language, you can generate new translations file manually, or you can contact me, and I will do it for you. You cand send me your translations again by e-mail or at github.            <br/><br/>
            More information about translating <a href='https://github.com/QupZilla/qupzilla/wiki/Translating'>here</a> [wiki at github]            </p>
            <a name="donate"></a>
            <h4>Donate</h4>
            <p>If you like QupZilla, you can also donate a small amount of money.            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" style="display:inline;padding-right:15px;">
