...
$LANG = array(
   ...
   "older_versions_text"      => "Zajímá Vás co nového se stalo od této verze po tuto? <br/><br/>Kompletní <a>changelog</a> všech verzí lze nalézt na githubu!",
   ...
   "technology_text"          => "QupZilla je moderní webový prohlížeč založený na jádře WebKitu a frameworku Qt. WebKit zaručí <a>rychlé</a> zobrazení stránek a Qt funkčnost na všech majoritních platformách.",
   ...
   "contribute_text"          => "QupZilla je open source projekt, Vaše pomoc je tedy vítána! Velmi rád zahrnu patche, které mi pošlete. Úprava zdrojových kódů však není jediný způsob jak pomoci, můžete přeložit QupZillu do Vašeho jazyku nebo se pouze podělit se svými přáteli. Každá (i malá) pomoc se cení.",
   ...
   "screens_thanksto"         => "díky",
   "screens_other"            => "Ostatní",
   "copyright_comm"           => "a QupZilla komunita",
   "laptop_icon"              => "Ikona laptopu od Oxygen Project",
   "page_trans"               => "Dostupné překlady:"
);?>
