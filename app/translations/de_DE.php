...
$LANG = array(
   ...
   "actual_version_text"      => "Die aktuelle Version $qupzilla_version ist am $qupzilla_version_date erschienen. Die Änderungen entnehmen Sie bitte dem CHANGELOG. <br/><br/>Direkt zum <a href=\"download\">DOWNLOAD</a>",
   ...
   "reportbug_text"           => "Haben Sie einen Programmfehler entdeckt oder einen Vorschlag, wie QupZilla <a>verbessert</a> werden kann?<br/> Bitte erstellen Sie einen Report bei github.",
   "reportbug_button"         => "Erstellen",
   "technology"               => "Technologie",
   "technology_text"          => "QupZilla ist ein moderner Web Browser, der auf WebKit und dem Qt Framework basiert. WebKit ermöglicht <a>schnelles</a> Browsen, Qt die Verfügbarkeit auf allen wichtigen Plattformen.",
