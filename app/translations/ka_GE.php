...
$LANG = array(
   ...
   "actual_version_text"      => "მიმდინარე ვერსიის თარიღი არის $qupzilla_version_date და ეს არის $qupzilla_version ვერსია. ცვლილებები იხილეთ ცვლილებების ჟურნალში.<br/>არ მოგერიდოთ და <a href=\"download\">ჩამოტვირთეთ</a> ის ახლავე!",
   ...
   "reportbug_text"           => "იპოვეთ რაიმე შეცდომა ან გაქვთ რჩევა თუ როგორ შეიძლება QupZilla-ს <a>გაუმჯობესება</a>?<br/>გთხოვთ შეგვატყობინეთ ამის შესახებ შეცდომების მეთვალყურე github-ზე.",
   "reportbug_button"         => "ახლავე შეტყობინება",
   "technology"               => "ტექნოლოგია",
   "technology_text"          => "QupZilla არის თანამედროვე ვებ ბრაუზერი რომელიც დაფუძნებულია WebKit-ზე და Qt Framework-ზე. WebKit არის <a>სისწრაფის</a> გარანტია ხოლო Qt ყველა ძირითად პლატფორმაზე ხელმისაწვდომობის.",
   ...
   "creators_text"            => "პროექტის მფლობელი და მთავარი დეველოპერი არის ჩეხი სტუდენტი <b>David Rosca</b> (nowrep).<br/>პროგრამისტების გარდა, თარგმნებსა და QupZilla-ს მხარდაჭერაში სხვა ხალხიც იღებს მონაწილეობას. მონაწილეების სრული სია შეგიძლიათ იხილოთ <a href='https://github.com/QupZilla/qupzilla/blob/master/AUTHORS'>აქ</a> [at github].<br/><br/>თქვენ ასევე შეგიძლიათ შემოუერთდეთ IRC არხს <b>#qupzilla</b> irc.freenode.net-ზე რათა ისაუბროთ ხალხთან რომლებიც QupZilla-ს განვითარებაში იღებენ მონაწილეობას.",
   "donate"                   => "Donate",
