...
$LANG = array(
   ...
   "reportbug_text"           => "آیا باگی پیدا کرده‌اید یا پیشنهادی برای <a>بهتر شدن</a> کوپزیلا دارید؟<br/> لطفا یک موضوع در github issue tracker بازکنید.",
   "reportbug_button"         => "گزارش کنید",
   "technology"               => "تکنولوژی",
   "technology_text"          => "کوپزیلا یک مرورگر وب امروزی است که بر پایه هسته WebKit و چهارچوب Qt نوشته شده است. WebKit مرور <a>سریع</a> وب و Qt در دسترس بودن برای همه سکوهای اصلی را تضمین می‌کنند.",
   ...
   "creators_text"            => "مالک، نگه‌دارنده و توسعه‌دهنده اصلی پروژه، دانشجوی اهل چک <b>David Rosca</b> (nowrep)&lrm; است.<br/> بجز کدنویسی، دیگران بوسیله برگردان و یا حمایت از کوپزیلا همکاری کرده‌اند. فهرست کامل همکارها در <a href='https://github.com/QupZilla/qupzilla/blob/master/AUTHORS'>اینجا</a> [در github] پیدا می‌شود.<br/><br/>می‌توانید از طریق وصل شدن به IRC روی کانال <b>&lrm;#qupzilla</b> در irc.freenode.net با افراد درگیر با کوپزیلا چت کنید.",
   "donate"                   => "Donate",
