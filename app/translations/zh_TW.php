...
$LANG = array(
   ...
   "reportbug"                => "回報問題",
   "reportbug_text"           => "發現了錯誤或只是<a>意見</a>要給QupZilla?<br/>請開啟Github的Issue並幫助我們吧。",
   "reportbug_button"         => "現在回報",
   "technology"               => "技術",
   "technology_text"          => "QupZilla是一款基於WebKit核心以及Qt Framework的強大瀏覽器。WebKit提供了<a>快速的</a> 瀏覽體驗且Qt使得此程式可以在各種主流平台上運行。",
