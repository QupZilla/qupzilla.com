...
$LANG = array(
   ...
   "reportbug_text"           => "Ви знайшли помилку або у Вас є пропозиції як <a>удосконалити</a> QupZill'у?<br/>Будь-ласка, розкажіть про це на трекері github.",
   "reportbug_button"         => "Повідомити зараз",
   "technology"               => "Технологія",
   "technology_text"          => "QupZilla - це сучасний веб-переглядач на базі ядра WebKit і Qt Framework. WebKit гарантує <a>швидкий</a> перегляд сторінок, а Qt - доступність на всіх основних платформах.",
