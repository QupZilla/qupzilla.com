...
$LANG = array(
   ...
   "reportbug_text"           => "Открили сте неку грешку или имате приједлог за <a>побољшање</a> Капзиле?<br/>Направите пријаву на Гитхабовом пратиоцу пријава.",
   ...
   "creators_text"            => "Власник пројекта, одржавалац и главни програмер је чешки студент <b>Давид Роска</b> (David Rosca - nowrep).<br/>Поред кодирања, и други су такође допринијели тиме што преводе или подржавају Капзилу. Потпун списак доприносиоца се може наћи <a href='https://github.com/QupZilla/qupzilla/blob/master/AUTHORS'>овдје</a> [на гитхабу].<br/><br/>Такође, можете се придружити ИРЦ каналу <b>#qupzilla</b> на irc.freenode.net да бисте ћаскали са људима укљученим у пројект Капзила.",
   "donate"                   => "Донирајте",
