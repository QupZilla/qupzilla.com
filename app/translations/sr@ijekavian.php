...
$LANG = array(
   ...
   "windows_text"             => "Инсталатер и преносно издање за Виндоуз можете преузети кликом на везе испод",
   ...
   "creators_text"            => "Осим програмирања, други доприносе и превођењем или донирањем пројекту. Потпун списак доприносиоца се налази <a href='https://github.com/QupZilla/qupzilla/blob/master/AUTHORS'>овдје</a> [на Гитхабу].<br/>Такође можете да се придружите ИРЦ каналу <b>#qupzilla</b> на irc.freenode.net да бисте ћаскали са људима укљученим у пројекат Капзила.",
   "donate"                   => "Донирајте",
...
Капзила посједује све стандардне функције које очекујете од веб прегледача. То укључује обиљеживаче и историјат (у бочној траци, такође) и језичке. Осим тога, подразумијевано блокира рекламе помоћу уграђеног Адблок прикључка.",
   "history"                  => "Историјат",
...
До издања 2.0 Капзила је користила Кутов вебкит. Кутов вебкит (QtWebKit) је сада застарио па новија издања користе Кутов вебенџин (QtWebEngine).",
   "creatortext1"             => "Власник пројекта и главни програмер",
   "creatortext2"             => "Студент на Чешком техничком универзитету",
