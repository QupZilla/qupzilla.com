...
$LANG = array(
   ...
   "actual_version_text"      => "Тренутно издање је $qupzilla_version објављено $qupzilla_version_date. Измене су у фајлу дневника измена. <br/>Не оклевајте и <a href=\"download\">преузмите</a> одмах!",
   ...
   "reportbug_text"           => "Открили сте неку грешку или имате предлог за <a>побољшање</a> Капзиле?<br/>Направите пријаву на Гитхабовом пратиоцу пријава.",
   "reportbug_button"         => "Пријави",
   "technology"               => "Технологија",
   "technology_text"          => "Капзила је модеран веб прегледач заснован на Вебкит језгру и Кут радном окружењу, што гарантује <a>брзину</a> и доступност на свим главним платформама.",
   "technology_button"        => "Вебкит и Кут",
   ...
   "ubuntu_text"              => "Корисници Убунту издања Precise, Oneiric, Natty и Maverick могу инсталирати Капзилу покретањем ових наредби",
   ...
   "creators_text"            => "Власник пројекта, одржавалац и главни програмер је чешки студент <b>Давид Роска</b> (David Rosca - nowrep).<br/>Поред кодирања, и други су такође допринели тиме што преводе или подржавају Капзилу. Потпун списак доприносиоца се може наћи <a href='https://github.com/QupZilla/qupzilla/blob/master/AUTHORS'>овде</a> [на гитхабу].<br/><br/>Такође, можете се придружити ИРЦ каналу <b>#qupzilla</b> на irc.freenode.net да бисте ћаскали са људима укљученим у пројект Капзила.",
   "donate"                   => "Донирајте",
