...
$LANG = array(
   ...
   "reportbug"                => "ΑΝΑΦΟΡΑ",
   "reportbug_text"           => "Βρήκατε κάποιο bug ή μήπως έχετε να κάνετε κάποια πρόταση για τη <a>βελτίωση</a> του QupZilla;<br/> Παρακαλώ ανοίξτε ένα issue στον ιχνηλάτη προβλημάτων του github.",
   "reportbug_button"         => "ΑΝΑΦΟΡΑ ΤΩΡΑ",
   "technology"               => "ΤΕΧΝΟΛΟΓΙΑ",
   "technology_text"          => "Ο QupZilla είναι ένας μοντέρνος περιηγητής ιστού βασισμένος στον WebKit core και το Qt Framework. Το WebKit εγγυάται <a>γρήγορη</a> περιήγηση και το Qt διαθεσιμότητα σε όλες τις μεγάλες πλατφόρμες.",
