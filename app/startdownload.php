...
switch ($query)
{
    ...
    case "windows64":
    case "windows":
        header("Location:/uploads/qupzilla189.exe");
    break;

    case "windows_portable":
        header("Location:/uploads/qupzilla189_portable.zip");
    break;
    ...
    case "source":
        header("Location:https://github.com/QupZilla/qupzilla/releases/tag/v1.8.9");
    break;
