...
switch ($query)
{
    case "windows":
    case "windows32":
        header("Location:https://github.com/QupZilla/qupzilla/releases/download/v" . $qupzilla_version . "/QupZilla." . $qupzilla_version . ".Installer.exe");
    break;

    case "windows64":
        header("Location:https://github.com/QupZilla/qupzilla/releases/download/v" . $qupzilla_version . "/QupZilla." . $qupzilla_version . ".x64.Installer.exe");
    break;

    case "windows_portable":
        header("Location:https://github.com/QupZilla/qupzilla/releases/download/v" . $qupzilla_version . "/QupZilla." . $qupzilla_version . ".Portable.Installer.exe");
    break;
